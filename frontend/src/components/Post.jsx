...
function Post({ post, index, onLike, onDelete, onCommentAdded }) {
        ...
        if (!showComments) {
            ...
            try {
                const res = await fetch(
                    `https://wesnap-server.onrender.com/api/comments/${post._id}`,
                    { credentials: "include" }
                );
    ...
    const handleLike = async () => {
        try {
            const res = await fetch(
                `https://wesnap-server.onrender.com/api/posts/${post._id}/like`,
                {
                    method: "POST",
                    credentials: "include",
                }
    ...
    const handleCommentSubmit = useCallback(
        async (e) => {
            ...
            try {
                const res = await fetch("https://wesnap-server.onrender.com/api/comments", {
                    method: "POST",
                    credentials: "include",
                    headers: {
